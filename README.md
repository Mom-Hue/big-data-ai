...
> 本仓库为课程学习成果提交。主要成果：**Python→AI 八次课学习地图**、**17 个概念学习资料**、**Agent Skill 学习与测评汇总长文**、**三色概念学习卡**、课程学习笔记（`notes/`）、代码练习（`code/`）。
...
| 🗺️ `学习地图/` | **Python → AI 八次课学习地图** | [打开](学习地图/learning-map.md) |
| 📚 `学习资料/` | **17 个概念学习资料（含概念目录页）** | [打开](学习资料/README.md) |
